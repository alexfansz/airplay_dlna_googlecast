...
public class Alert extends Dialog implements DialogInterface {
    ...
    private com.xindawn.DLAN.plugins.widget.AlertController mAlert;
    ...
    protected Alert(Context context, int theme) {
        super(context, theme);
        mAlert = new com.xindawn.DLAN.plugins.widget.AlertController(context, this, getWindow());
    }
    ...
    public static class Builder {
        private final com.xindawn.DLAN.plugins.widget.AlertController.AlertParams P;
        
        /**
         * Constructor using a context for this builder and the {@link AlertDialog} it creates.
         */
        public Builder(Context context) {
            P = new com.xindawn.DLAN.plugins.widget.AlertController.AlertParams(context);
        }
